...
<div align="center">"🇬🇧" (README.md) · 🇷🇺 · "🇨🇳" (README.zh.md) · "🇪🇸" (README.es.md) · "🇩🇪" (README.de.md) · "🇫🇷" (README.fr.md) · "🇯🇵" (README.ja.md) · "🇰🇷" (README.ko.md)

</div>«Автоматически обновляемое зеркало публичных данных "BenchLM" (https://benchlm.ai/).»
...
Код и конфигурация данного репозитория распространяются под "MIT License" (./LICENSE).
